...
sim_no = sys.argv[21]
# parameters for membrane / nucleus interaction
inter_a = float(sys.argv[22])
inter_n = float(sys.argv[23])
inter_cutoff = float(sys.argv[24])
...
system.non_bonded_inter[0,1].soft_sphere.set_params(a = inter_a, n = inter_n, cutoff = inter_cutoff, offset = 0.0)
